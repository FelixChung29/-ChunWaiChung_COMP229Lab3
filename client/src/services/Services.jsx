...
function Services() {
  const services = [
  {
    icon: '/img/fullstack-development-mern-illustration.png',
  ...
  {
    icon: '/img/testing-debugging-app-reliability-graphic.png',
  ...
  {
    icon: '/img/ui-ux-design-user-centered-visual.png',
    title: '🎨 UI/UX Design',
