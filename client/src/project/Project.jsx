        ...
        <div
          ...
          onClick={() =>
            openModal('/img/project3.png', {
              ...
              link: '/img/pokedex/index.html',
            })
          }
        >
          <img src="/img/project3.png" alt="Pokédex" />
        ...
        <div
          ...
          onClick={() =>
            openModal('/img/project2.png', {
              ...
              link: '/img/word-guessing-game/index.html',
            })
          }
        >
          <img src="/img/project2.png" alt="Word Game" />
          <div className="overlay">View</div>
        </div>
        ...
        <div
          ...
          onClick={() =>
            openModal('/img/project1.png', {
              ...
              link: '/img/traffic-light/index.html',
            })
          }
        >
          <img src="/img/project1.png" alt="Traffic Light" />
          <div className="overlay">View</div>
        </div>
      </div>
